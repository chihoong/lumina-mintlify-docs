...
Kiosk mode locks the iPad to the guest-facing ordering screen so customers can't access your settings or leave the app. The lock is built into the Lumina Kiosk app — you don't need iOS Guided Access.

**When kiosk mode is on**, the device stays on the welcome and ordering screen at all times.

**To return to operator controls**, a staff member follows these steps:
