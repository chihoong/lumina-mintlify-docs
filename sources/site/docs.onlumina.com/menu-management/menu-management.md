# Source: https://docs.onlumina.com/menu-management/menu-management
...
## [86'ing items](https://docs.onlumina.com/#86ing-items)
...
## [Menu Groups](https://docs.onlumina.com/#menu-groups)
...
![Kiosk menu showing menu group titles down the left side and a menu group cover image at the top of the Drinks & Smoothies section](https://docs.onlumina.com/docs-img/menu-management/menugroups.png)
...
## [Collections](https://docs.onlumina.com/#collections)
...
1. In the **Menus** tab, open **Collections** and tap **Add Collections** → **Create new collection**.
...
## [Sync with Square](https://docs.onlumina.com/#sync-with-square)
...
- [Loyalty](https://docs.onlumina.com/loyalty/loyalty) — promote rewards signup with a Collection.
- [Kiosk operations](https://docs.onlumina.com/kiosk-operations/kiosk-operations) — set which profile (and menu) a device runs.